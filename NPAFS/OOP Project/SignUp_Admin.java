...
public class SignUp_Admin extends JFrame {
     ArrayList<LoginANDRegistration> List = new ArrayList<LoginANDRegistration>();
     File file = new File("C://Users//pcs//Desktop//Nayyar Project//nayya//src//nayya/AdminInfo.text");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SignUp_Admin frame = new SignUp_Admin();
	...
	public SignUp_Admin() {
		...
		JLabel Label1 = new JLabel("WELCOME TO SIGNUP PAGE OF ADMIN");
		...
		JButton BTNSIGNUP_ADMIN = new JButton("SIGNUP");
		BTNSIGNUP_ADMIN.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List.add(obj);
					...
					if(e.getSource() == BTNSIGNUP_ADMIN) {
						    String username;
				            String password;
				            String cnic;
				            String email;
						 ...
						 JOptionPane.showMessageDialog(null,"Username Field can't empty");
				            ...
				            try 
						     { 
						        FileWriter fw=new FileWriter("C://Users//pcs//Desktop//OOP_PROJJECT_FINAL//nayya//src//nayya/AdminInfo.text",true);
		...
		BTNSIGNUP_ADMIN.setFont(new Font("Times New Roman", Font.BOLD, 12));
		BTNSIGNUP_ADMIN.setBounds(180, 209, 77, 20);
		contentPane.add(BTNSIGNUP_ADMIN);
